...
def setup(app: Application) -> None:
    ...
    app.add_handler(CallbackQueryHandler(callbacks.toggle_rule_r4, pattern=r"^toggle_rule_r4$"))

    # Bets history
    app.add_handler(CallbackQueryHandler(callbacks.show_bets_history, pattern=r"^bets_history$"))
    app.add_handler(CallbackQueryHandler(callbacks.show_bets_rule,    pattern=r"^bets_r[234]$"))
    app.add_handler(CallbackQueryHandler(callbacks.export_csv,        pattern=r"^export_csv_r[234]$"))

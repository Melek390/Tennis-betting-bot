...
class TelegramBot:
    ...
    async def send_heartbeat(self, match_count: int, kalshi_count: int = 0) -> None:
        await self._send(alerts.heartbeat_text(match_count, kalshi_count, self._state.enabled))
